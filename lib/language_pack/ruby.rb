...
ERROR
  ...
  def build_bundler
    log("bundle") do
      ...
      trust_policy = ENV['GEM_TRUST_POLICY'] || 'MediumSecurity'
      bundle_command = "bundle install --without #{bundle_without} --path vendor/bundle --binstubs vendor/bundle/bin --trust-policy #{trust_policy}"
